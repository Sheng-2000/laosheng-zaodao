...
prices = ["7.42", "10.17", "6.61", "38.57", "31.29", "11.55", "16.11", "11.48", "27.19", "5.04", "92.99", "9.23", "52.99"]
changes = ["-1.98%", "-2.12%", "-1.05%", "-0.98%", "-0.92%", "-2.20%", "-1.04%", "-1.20%", "-1.38%", "-0.59%", "-1.32%", "-0.22%", "-2.29%"]
volumes = ["27.6亿", "12.8亿", "18.0亿", "30.5亿", "3.6亿", "12.3亿", "4.5亿", "1.4亿", "32.9亿", "3.0亿", "8.9亿", "16.7亿", "43.3亿"]
...
replacements["{{高股息_银行内容}}"] = """银行板块当前<span style="color:#f85149;font-weight:700">平均PB仅0.85倍</span>，处于历史15%分位，<span style="color:#f85149;font-weight:700">估值安全边际极高</span>。6家国有大行平均股息率超5.8%，<span style="color:#f85149;font-weight:700">显著高于10年期国债收益率2.385%</span>，性价比突出。
<br>📌 <b>资产质量改善</b>：5月末商业银行不良贷款率<span style="color:#3fb950;font-weight:700">1.45%</span>，环比下降0.02pct，拨备覆盖率<span style="color:#f85149;font-weight:700">305%</span>，风险抵补充足。
<br>📌 <b>资金流入</b>：北向资金近5日净买入银行板块<span style="color:#f85149;font-weight:700">+45.6亿</span>，险资、社保基金持续加仓。
<br>📌 <b>配置建议</b>：建议关注工商银行、建设银行、农业银行等<span style="color:#f0b429;font-weight:700">高股息+低估值</span>双重逻辑标的，持有3年以上年化收益可达6-8%。"""

replacements["{{高股息_公用事业标题}}"] = "公用事业"
replacements["{{高股息_公用事业内容}}"] = """公用事业板块以<span style="color:#f85149;font-weight:700">稳定的现金流</span>和<span style="color:#f85149;font-weight:700">高分红率</span>著称，是典型的防御型资产。核心标的（长江电力、中国核电等）平均股息率<span style="color:#f85149;font-weight:700">4.5%</span>，部分公司股息率超6%。
<br>📌 <b>长江电力</b>：乌东德/白鹤滩电站全面投产，装机容量<span style="color:#f85149;font-weight:700">全球第一</span>，现金流极度稳定，分红比例承诺<span style="color:#f85149;font-weight:700">70%以上</span>。
<br>📌 <b>中国核电</b>：核电装机国内领先，新机组审批加速，<span style="color:#f0b429;font-weight:700">成长确定性</span>+稳定分红双驱动。
<br>📌 <b>配置建议</b>：在市场波动加大环境下，公用事业可作为<span style="color:#f85149;font-weight:700">底仓配置</span>，建议占比20-30%。"""

replacements["{{高股息_电力标题}}"] = "电力板块"
replacements["{{高股息_电力内容}}"] = """电力板块整体业绩稳定，<span style="color:#f85149;font-weight:700">分红持续</span>，是稳健投资的优选。核心逻辑在于：1）电改红利持续释放；2）绿电交易溢价；3）央企估值修复。
<br>📌 <b>火电</b>：受煤价回落影响，盈利改善预期增强，<span style="color:#f85149;font-weight:700">华能国际/华电国际</span>等龙头股息率超5%。
<br>📌 <b>水电</b>：长江电力等龙头<span style="color:#f85149;font-weight:700">防御属性极强</span>，过去5年累计涨幅超80%。
<br>📌 <b>新能源运营</b>：龙源电力、三峡能源等受益于绿电交易，<span style="color:#f0b429;font-weight:700">成长空间打开</span>。
<br>📌 <b>配置建议</b>：建议关注业绩稳定+高分红的水电龙头，<span style="color:#f85149;font-weight:700">长期持有</span>获取稳定股息收益。"""

replacements["{{高股息_央企标题}}"] = "央企蓝筹"
replacements["{{高股息_央企内容}}"] = """央企蓝筹板块在<span style="color:#f85149;font-weight:700">中字头估值修复</span>+<span style="color:#f85149;font-weight:700">高分红</span>双重逻辑下持续走强，是本轮A股反弹的重要力量。核心标的（中国移动、中国神华、中国海油等）平均股息率超5.5%。
<br>📌 <b>通信龙头</b>：中国移动5G基站数全球第一，<span style="color:#f85149;font-weight:700">算力网络建设加速</span>，股息率5.5%。
<br>📌 <b>能源龙头</b>：中国神华<span style="color:#f85149;font-weight:700">吨煤利润185元</span>，股息率7.2%，现金奶牛属性突出。
<br>📌 <b>油服龙头</b>：中国海油桶油利润55美元，受益于油价中枢上移，<span style="color:#f85149;font-weight:700">业绩高弹性</span>。
<br>📌 <b>政策支持</b>：国资委多次强调<span style="color:#f0b429;font-weight:700">提升央企估值</span>，新一轮国企改革深化推进，配置价值持续凸显。"""
